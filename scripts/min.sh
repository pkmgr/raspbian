...
RELEASE_TYPE="$(. /etc/os-release 2>/dev/null; [[ " $ID_LIKE " == *centos* ]] && echo "raspbian")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
retrieve_version_file() { grab_remote_file "https://github.com/casjay-base/raspbian/raw/main/version.txt" | head -n1 || echo "Unknown version"; }
domain_name() {
	local d="" f=""
...
# install_pkg cronie-noanacron  # skipped on raspbian
install_pkg postfix
...
# install_pkg biosdevname  # skipped on raspbian
install_pkg certbot
install_pkg cockpit
install_pkg cockpit-packagekit
install_pkg cockpit-storaged
install_pkg cockpit-pcp
# install_pkg cockpit-bridge  # skipped on raspbian
# install_pkg cockpit-system  # skipped on raspbian
# install_pkg cockpit-ws  # skipped on raspbian
...
# install_pkg deltarpm  # skipped on raspbian
install_pkg dialog
...
install_pkg grub-pc
# install_pkg grub2-tools-extra  # skipped on raspbian
# install_pkg grubby  # skipped on raspbian
install_pkg gzip
...
# install_pkg mod_geoip  # skipped on raspbian
# install_pkg mod_http2  # skipped on raspbian
# install_pkg mod_maxminddb  # skipped on raspbian
install_pkg libapache2-mod-perl2
# install_pkg mod_ssl  # skipped on raspbian
install_pkg libapache2-mod-wsgi-py3
# install_pkg mod_proxy_html  # skipped on raspbian
...
# install_pkg perl-DBD-Firebird  # skipped on raspbian
install_pkg php
install_pkg php-cli
...
install_pkg postfix
# install_pkg postfix-pcre  # skipped on raspbian
install_pkg python3-certbot-dns-rfc2136
install_pkg python3-configargparse
install_pkg python3-cryptography
# install_pkg python3-enum34  # skipped on raspbian
# install_pkg python3-funcsigs  # skipped on raspbian
install_pkg python3-future
install_pkg python3-idna
# install_pkg python3-josepy  # skipped on raspbian
# install_pkg python3-mock  # skipped on raspbian
install_pkg python3-pynvim
# install_pkg python3-parsedatetime  # skipped on raspbian
# install_pkg python3-pbr  # skipped on raspbian
install_pkg python3-pip
install_pkg python3-psutil
# install_pkg python3-pyasn1  # skipped on raspbian
# install_pkg python3-pyrfc3339  # skipped on raspbian
# install_pkg python3-pysocks  # skipped on raspbian
install_pkg python3-requests
# install_pkg python3-six  # skipped on raspbian
install_pkg python3-virtualenv
install_pkg libreadline-dev
# install_pkg rootfiles  # skipped on raspbian
install_pkg rsync
install_pkg rsyslog
install_pkg screen
install_pkg sed
